...
/* harmony import */ var _modules_fixed_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/fixed-header */ "./js/modules/fixed-header.js");
/* harmony import */ var _modules_fixed_header__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_fixed_header__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_cards_animation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/cards-animation */ "./js/modules/cards-animation.js");
/* harmony import */ var _modules_cards_animation__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_cards_animation__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_show_more__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_parallax__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/parallax */ "./js/modules/parallax.js");
...
/* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/accordeon */ "./js/modules/accordeon.js");
...
/* harmony import */ var _modules_main_screen_link__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/main-screen-link */ "./js/modules/main-screen-link.js");
/* harmony import */ var _modules_main_screen_link__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_main_screen_link__WEBPACK_IMPORTED_MODULE_8__);
...
var accordeon = document.querySelector('[data-el="accordeon"]');
var accordeonTitles = accordeon.querySelectorAll('[data-el="accordeon-title"]');
var accordeonButtons = accordeon.querySelectorAll('[data-el="accordeon-title"] button');
var accordeonDescrs = accordeon.querySelectorAll('[data-el="accordeon-description"]');
var accordeonLinks = accordeon.querySelectorAll('[data-el="accordeon-description"] a');
document.body.classList.remove(NOJS_CLASS);
accordeonTitles.forEach.call(accordeonTitles, function (accordeonTitle) {
  accordeonTitle.addEventListener('click', function () {
    var activeTitle = accordeon.querySelector('.is-active');
    var activeDescr = accordeon.querySelector('.is-visible');
    var clickedDescr = accordeonTitle.parentElement.querySelector('[data-el="accordeon-description"]');
    var clickedDescrLinks = clickedDescr.querySelectorAll('a');
    accordeonLinks.forEach(function (accordeonLink) {
      accordeonLink.setAttribute('tabindex', -1);
    });
    clickedDescrLinks.forEach(function (clickedDescrLink) {
...
var accordeonFocusHandler = function accordeonFocusHandler() {
  if (isMobileWidth.matches) {
    ...
    accordeonDescrs.forEach(function (accordeonDescr) {
...
var SPEED = 0.03;
var cards = document.querySelectorAll('[data-el="card"]');

var onCardMove = function onCardMove(evt) {
  var cardBox = evt.currentTarget.querySelector('[data-el="card-box"]');
  var a = (evt.offsetY - cardBox.offsetHeight / 2) * SPEED;
  var b = -(evt.offsetX - cardBox.offsetWidth / 2) * SPEED;
  cardBox.setAttribute('style', "transform: rotateX(".concat(a, "deg) rotateY(").concat(b, "deg)"));
};

var onCardOut = function onCardOut(evt) {
  var cardBox = evt.currentTarget.querySelector('[data-el="card-box"]');
...
var PRELOADED_CLASS = 'is-preloaded';
var FIXED_CLASS = 'is-fixed';
var ACTIVE_CLASS = 'is-active';
var header = document.querySelector('[data-el="header"]');
var firstBlock = document.querySelector('[data-el="first-block"]');
var referenceHeights = {
  headerHeight: header.offsetHeight,
  firstBlockHeight: firstBlock.offsetHeight
};

var headerResizeHandler = function headerResizeHandler() {
...
/***/ "./js/modules/main-screen-link.js":
/*!****************************************!*\
  !*** ./js/modules/main-screen-link.js ***!
  \****************************************/
/*! no static exports found */
...
var MOBILE_WIDTH = '(max-width: 767px)';
var isMobileWidth = window.matchMedia(MOBILE_WIDTH);
var mainScreenLink = document.querySelector('[data-el="main-screen-link"]');

var mainScreenLinkHandler = function mainScreenLinkHandler() {
  if (isMobileWidth.matches) {
...
var parallaxArea = document.querySelector('[data-el="parallax"]');
var layers = parallaxArea.querySelectorAll('[data-el="layer"]');

var parallax = function parallax(evt) {
  var parallaxWidth = parallaxArea.offsetWidth;
  var parallaxHeight = parallaxArea.offsetHeight;
  var coordX = evt.clientX - parallaxWidth / 2;
  var coordY = evt.clientY - parallaxHeight / 2;
...
var stopParallax = function stopParallax() {
  layers.forEach(function (layer) {
...
var aboutContent = document.querySelector('[data-el="about-content"]');
var aboutButton = document.querySelector('[data-el="about-btn"]');
...
var callbackForm = document.querySelector('[data-el="callback-form"]');
var callbackTelField = callbackForm.querySelector('[data-el="tel-field"]');
var callbackTelInput = callbackTelField.querySelector('[data-el="input-tel"]');
var feedbackForm = document.querySelector('[data-el="feedback-form"]');
var feedbackTelField = feedbackForm.querySelector('[data-el="tel-field"]');
var feedbackTelInput = feedbackTelField.querySelector('[data-el="input-tel-2"]');
var telMask = {
  mask: '+{7} (000) 000-00-00'
};
var callbackMask = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(callbackTelInput, telMask);
var feedbackMask = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(feedbackTelInput, telMask);
callbackForm.addEventListener('submit', function (evt) {
  evt.preventDefault();
  var telLength = callbackMask.unmaskedValue.length;
  var isTelValid = telLength === 11;
...
feedbackForm.addEventListener('submit', function (evt) {
  evt.preventDefault();
  var telLength = feedbackMask.unmaskedValue.length;
  var isTelValid = telLength === 11;
